"""
Django settings for Ganadera project.
...
SECRET_KEY = 'django-insecure-++^b_)^20pz=i1hb0#yxxj+6x@4aizhh7@&f8n+up)v**m4mxt'
...
LOGIN_REDIRECT_URL = 'aplicacion:Menu_Presentacion'